...
(async function () {
  ...
  try {
    ...
    for (let item in nhlScore) {
      ...
      console.log(nhlScore.gameData.venue.name);
      const awayteamName = nhlScore.gameData.teams.away.abbreviation;
       const hometeamScore = nhlScore.liveData.plays.currentPlay.about.goals.home
      const awayteamScore = nhlScore.liveData.plays.currentPlay.about.goals.away
